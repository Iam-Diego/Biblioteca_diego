...
public class ViewInicio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tarjetas.add(new Tarjeta(R.drawable.libro1, "Algorithms", "fourth edition", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro2, "Java 7", "Jeff Friese", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro3, "C# 6 Programming with  Visual studio 2015", "Benjamin Perkins", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro4, "C++", "D.ryan Stephens", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro5, "Code complete 2 ", "Steve McConnell", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro6, "Computer Systems", "Bryant", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro7, "cuba by example", "Jason Sanders", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro8, "Effective C++", "Scott Meyers", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro9, "Effective STL", "Scott Meyers", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro10, "Engeneering a compiler", "Keith D", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro11, "Expert C Programming", "Peter van del Linden", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro12, "IIIustrated C# 2010", "DAniel M. solis", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro13, "Algorithms", "Thomas H. Cormen", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro14, "python", "Mark Luiz", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro15, "MAchine Learning", "Stephen Marsland", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro16, "MAchine Learning in action", "Peter Harrington", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro17, "Modern Operating Systems", "Andrew S.", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro18, "Visual Studio 2010", "Patrice pelland", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro19, "Multiple view Geometry", "Richar Hartley ", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro20, "Operating system Concepts", "Gelvin S.", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro21, "Pattern Recognition adn Machine Learning", "Cristopher m.", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro22, "C# 2008", "Chritian negal", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro23, "C++", "Nicholas A.", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro24, "Collective Intrelligence", "Toby Segaran", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro25, "Python Cookbook", "DAvid Beazley", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro26, "Python for Data Analysis", "Wes Mckinneys", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro27, "The C++ Sytandard Library", "Nicolai M. ", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro28, "The Elements of Statiscal Learning", "Trevor Hastie", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro29, "The Proframatic", "Andrew Hunt", 350, 600, 5));
        tarjetas.add(new Tarjeta(R.drawable.libro30, "Teach Yourself JAVA in 21 Days", "Laura Lemay", 350, 600, 5));
